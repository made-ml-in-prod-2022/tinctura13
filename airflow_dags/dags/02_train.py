...
with DAG(
    ...
    start_train = DummyOperator(task="begin-train-pipeline")
    ...
    end_train = DummyOperator(task_id="end-train-pipeline")
    
    start_train >> [data_await, target_await] >> split >> preprocess >> train >> validate >> end_train
